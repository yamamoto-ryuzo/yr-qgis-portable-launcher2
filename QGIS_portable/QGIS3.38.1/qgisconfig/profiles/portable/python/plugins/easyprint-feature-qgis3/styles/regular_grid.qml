...
<qgis version="1.7.0-Wroclaw" minimumScale="0" maximumScale="1e+08" hasScaleBasedVisibilityFlag="0">
  ...
  <labelattributes>
    ...
    <size fieldname="" units="pt" value="20"/>
    <bold fieldname="" on="0"/>
  ...
  <edittypes>
    <edittype type="0" name="layoutindex"/>
    <edittype type="0" name="name"/>
    <edittype type="0" name="overlap"/>
    <edittype type="0" name="printformat"/>
    <edittype type="0" name="printscale"/>
